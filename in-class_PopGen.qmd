...
We examined the turbididy for the months of data (@tbl-turbidity).


```{r}
#| echo: FALSE 
#| label: "tbl-turbidity"
#| tbl-cap: "This is the real table caption that will be put above the actual table."
...
We measured daily air temperature and found deviations across days of the week (@tbl-airtemp).


```{r}
#| label: "tbl-airtemp"
#| tbl-cap: "This is the average air temperature for the Rice Rivers Center in the first few months of 2014 by day of the week."
#| echo: false 
...
data |>
  ...
  group_by( Weekday ) |> 
  summarize( Temperature = mean(`Air Temperature (°C)`) ) |>
  kable()
